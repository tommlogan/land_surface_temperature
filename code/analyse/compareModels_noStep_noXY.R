...
compareModels = function(){
  ...
  drops <- c("lst_mean","lst_max","lst_min","lcov_0","x","y","area","lcov_0_sl","lst_mean_sl","lst_max_sl","lst_min_sl")
  theData <- theData[ , !(names(theData) %in% drops)]
...
#   pcaData$response = theData$response
  ...
  modelNames = c("meanOnly", "glm1",  "gam1","mars1","tree1", "bag1", "rf1", "boost1", "glm2", "mars2","tree2", "bag2", "rf2", "boost2")
